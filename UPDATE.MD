**Version 1.1.0**
* Added support for multiple-render targets for improved performance and reduced code complexity.
* Switched out emulated 3D Textures to full 3D texture, which are now supported in WebGL 2.
