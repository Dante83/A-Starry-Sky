...
class VisibleStar:
    def __init__(self, galactic_coordinates, temperature, magnitude, galactic_latitude, galactic_longitude, index_in_potential_stars):
        ...
        self.position_in_med_star_ordererd_array = None
        self.med_star_array_x = None
        self.med_star_array_y = None
        ...
        self.encoded_equitorial_r = self.float2RGBA(self.galactic_coordinates[0] * temperature, -17000.0, 17000.0)
        self.encoded_equitorial_g = self.float2RGBA(self.galactic_coordinates[1] * temperature, -17000.0, 17000.0)
        self.encoded_equitorial_b = self.float2RGBA(self.galactic_coordinates[2] * temperature, -17000.0, 17000.0)
