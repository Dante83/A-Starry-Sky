...
var wasmBinaryFile = 'sky-state.wasm';
...
var real__swapSkyState = asm["_swapSkyState"]; asm["_swapSkyState"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__swapSkyState.apply(null, arguments);
};
...
var _swapSkyState = Module["_swapSkyState"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_swapSkyState"].apply(null, arguments) };
