...
void SkyManger::update(boolean updatePlanets){
  ...
  double sunsMeanLongitudeInRadsTimes2 = sun.getMeanLongitude() * DEG_2_RAD_TIMES_2;
  double moonsMeanLongitudeInRadsTimes2 = moon.getMeanLongitude() * DEG_2_RAD_TIMES_2;
  ...
  //Meeus 87
  double julianDay = astroTime.getJulianDay();
...
//Getters
//
Moon& SkyManager::getMoon(){
  return moon;
}

Sun& SkyManager::getSun(){
  return sun;
}
