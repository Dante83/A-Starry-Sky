...
#define RAYLEIGH_SCALE_HEGHT 8.0
...
#define TAN_OF_ONE_POINT_THREE_EIGHT_SIX 349623499187428997458118357100444434285067337233648122248
#define PARAMETER_TO_COS_ZENITH_OF_SUN_CONST 722695983908032851939963402997985942588713919243915613609
