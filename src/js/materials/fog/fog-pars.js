StarrySky.Materials.Fog.fogParsMaterial = {
  fragmentShader: function(mieDirectionalG, rayleigh, exposure, groundFexDistanceMultiplier){
    let originalGLSL = [
    '#ifdef USE_FOG',
  ...
  vertexShader: function(rayleigh, turbidty, mieCoefficient, groundDistanceMultp, solarRadius, lunarRadius, distanceForSolarEclipse){
    let originalGLSL = [
    '#ifdef USE_FOG',
    'varying float vFogDepth;',
      '#ifndef FOG_EXP2',
