...
//NOTE: It appears that there was an error with the original parameterization
...
void main(){
  ...
  if(!intersectsEarth){
    ...
    totalInscattering = intensity * (totalInscatteringMie * EARTH_MIE_BETA_EXTINCTION + totalInscatteringRayleigh * RAYLEIGH_BETA);
  }
