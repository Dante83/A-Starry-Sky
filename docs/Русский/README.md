...
`<sky-moon-angular-diameter>` | Угловой диаметр Луны в небе.  | 3.15 градусов
`<sky-sun-angular-diameter>` | Угловой диаметр Солнца в небе. | 3.38 градусов
`<sky-number-of-atmospheric-lut-ray-steps>` | Количество шагов луча до края неба, которые делает трассировщик при сборе света для атмосферных LUT (таблиц поиска). | 30 шагов
`<sky-number-of-atmospheric-lut-gathering-steps>` | Количество угловых шагов в каждой точке вдоль луча для рассеяния k-го порядка. | 30 шагов
